...
const Contact: React.FC = () => {
  ...
  return (
    <div className={styles.contactPageWrapper}> {/* Change class here to contactPageWrapper for gradient */}
      <div className={styles.contactPage}> {/* Keep the inner content inside the contactPage */}
